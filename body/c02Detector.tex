...
The total time-of-flight resolution, including the resolution on the collision time, is about $90$~ps in pp collisions(\emp{some paper write as $100$~ps. And how many for \pPb?}).
